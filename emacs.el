...
(defun config-parentheses ()
  ...
  (show-paren-mode 1)
  (set-face-background 'show-paren-match (face-background 'spaceline-evil-emacs))
...
(defun config-r ()
  ...
  (add-to-list 'load-path "~/.emacs.d/poly-markdown")
  (add-to-list 'load-path "~/.emacs.d/poly-R")
  (autoload 'poly-markdown+r-mode "poly-R.elc" nil t)
  (autoload 'poly-noweb+r-mode "poly-R.elc" nil t)
  (autoload 'poly-html+r-mode "poly-R.elc" nil t)
